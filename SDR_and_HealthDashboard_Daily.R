...
#Upload excel sheets into google sheet - you first need to run like so
# gs_upload("rsid1.xlsx", sheet_title ="lulusproduction", verbose = TRUE)
#gs_upload ("rsid2.xlsx", sheet_title ="lulusproduction", verbose = TRUE)
